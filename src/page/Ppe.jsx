...
import ViewPpe from "../components/ViewPpe"; // adjust the path as needed
...
export default function PPE() {
  const [assets, setAssets] = useState([
    ...
    { id: 3, serialNumber: "SN345678", category: "Server", remarks: "Turn In" },
    { id: 4, serialNumber: "SN456789", category: "Switch", remarks: "Operational" },
  ]);
...
>
  View
</button>                    <button className="text-red-600 hover:underline">Delete</button>
                  </td>
                </tr>
              ))}
            </tbody>
      ...
      {/* Add New Item Button (fixed bottom right) */}
      ...
      {/* Modal */}
       <Category
              ...
              onAdd={handleAddAsset}
                source="PPE" // Pass the identifier
